  ...
  return (
    <html lang="en" className={geist.variable}>
       ...
       <header className="border-b border-gray-100 dark:border-gray-800 sticky top-0 bg-white dark:bg-gray-950 z-10">
            ...
            {/* blog name */}
            <Link href="/" className="font-semibold text-gray-900 dark:text-white tracking-tight hover:text-gray-600 transition-colors duration-200">
              Lens of Kushal
            </Link>

            {/* desktop links — hidden on mobile */}
            <div className="hidden md:flex items-center gap-6 text-sm text-gray-500">
              <Link href="/movies" className="hover:text-gray-900 transition-colors duration-200">Movies</Link>
              <Link href="/books" className="hover:text-gray-900 transition-colors duration-200">Books</Link>
              <Link href="/poetry" className="hover:text-gray-900 transition-colors duration-200">Poetry</Link>
